  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">{{ Auth::user()->username }} :: {{ $role }}</a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('add/settings')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add settings</p>
                </a>
              </li>
         ...
         @endif 
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('add/tags')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Tags</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('manage/tags') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Tags</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('add/posts')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Posts</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('manage/posts') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Posts</p>
                </a>
              </li>

...
<div class="container-fluid">
 	  <div>
 	 	<h1 class="text-center">Search result for :: {{ $search }}</h1>
 	 </div>
 	 <div class="container">
 	 	<div class="row">
 	 		<div class="col-md-8">
 		...
 		<div class="col-md-12">
 			<div class="row ">
 				...
 				<div class="col-lg-6 ">
 						...
 						<img src="{{ asset('uploads/post_photos') }}/{{ $item->image }}">
 						<div class="card-body">
 							<h5 class="card-title">{{  $item->post_name }}</h5>
 							
 							<p class="card-text">{{ $item->category->name  }}</p>
 							<a href="{{ url('category/post') }}/{{ $item->id  }}" class="btn btn-primary">view full..</a>
 						</div>
 			        </div>
